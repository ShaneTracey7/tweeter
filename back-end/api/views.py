...
from api.models import Image, User, Tweet, Message, Follow, Like, Retweet, Notification, Convo, UserMessage
    ...
    def post(self, request):
        ...
        if type_input == 'bio':
            ...
            if type_input.find('header') != -1:
                ...
                return JsonResponse([image_serializer,image_serializer2],safe=False) #both images are saved
